...
```
galaxyplay <command> [arguments] [flags]
```

Run `galaxyplay <command> --help` for the full flag list on any command. This
...
per operation you declare in `galaxyplay/domain.go`.
