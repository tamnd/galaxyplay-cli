...
Most of these come down to network reality or how galaxyplay serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

galaxyplay rate-limits like any public site. galaxyplay already paces
...
Where a surface is gated, galaxyplay reads a cookie or token you supply
...
`galaxyplay`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what galaxyplay actually did
